...
public class OthersWatchingVideosCategoryLoader extends CategoryDataLoader {
    ...
    private void loadData() {
        ...
        for (Map.Entry<String, AppInfo> entry : entrySet) {
            ...
            for (String videoId : videoIds) {
                ...
                if (video == null) {
                    othersWatchingVideosLogger.warn("Video info for video id : " + videoId + " is not present in " +
                            "AppInfo Object...");
                }
    ...
    public Category getTopLevelCategory() {
        ...
        category.setId(ID);
        category.setName(propertyHelper.getStringProperty(PropertyNames.OTHERSWATCHING_CATEGORY_NAME, null));
        category.setImageURL(webAPIUtil.getImageURL(propertyHelper.getStringProperty(PropertyNames
                .OTHERSWATCHING_CATEGORY_IMAGE_ID, null)));
        return category;
    }
