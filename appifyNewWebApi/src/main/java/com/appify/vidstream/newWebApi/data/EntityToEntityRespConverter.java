...
import com.appify.vidstream.newWebApi.EntityResp;
import com.appify.vidstream.newWebApi.LoadAppServlet;
import com.appify.vidstream.newWebApi.OrderAttributeResp;
...
public class EntityToEntityRespConverter {
	...
	static final Logger entityToEntityRespConverterLogger = Logger.getLogger(EntityToEntityRespConverter.class);
	...
	public EntityResp getEntityRespWithoutChildren(Entity entity)
	{
