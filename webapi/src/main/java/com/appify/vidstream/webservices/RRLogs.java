...
public class RRLogs implements ApiConstants{
	...
	public void getLoadAppData(String apiname, String requestparam,
			JSONObject categorizationObj, String responseTime, String authenticationMessage) {
		...
		finalJsonObject.put("response", categorizationObj);
